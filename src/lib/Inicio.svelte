...
<div class="flex flex-col md:flex-row justify-between items-center z-1">
  ...
  >
    ...
    <div class="relative z-10 w-full">
      ...
      <p class="flex justify-center">o</p>
      <button class="glow-on-hover bg-white text-gray-600 rounded px-4 py-2 font-bold w-full" on:click={handleOauthGmail}>Login with Google</button>
      <!-- <button

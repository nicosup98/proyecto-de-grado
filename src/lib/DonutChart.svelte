<script>
   ...
   export let width = 570 // the outer width of the chart, in pixels
   ...
   const labelPosition = 0.35; // the position of the label offset from center
